...
import { FiMail, FiLock, FiArrowRight, FiShield, FiUser, FiEdit3 } from 'react-icons/fi';
      ...
      <div className="max-w-md w-full space-y-8 bg-white border border-brand-darkgreen/5 p-8 rounded-3xl shadow-lg">
        ...
        <div className="bg-brand-cream/45 p-1 rounded-xl grid grid-cols-3 gap-1 border border-brand-darkgreen/5">
          <button
            ...
            className={`py-2 text-xs font-semibold rounded-lg transition-all flex flex-col items-center justify-center ${
              role === 'reader' 
